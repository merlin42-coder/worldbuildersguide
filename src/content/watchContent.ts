...
export const watchContent: WatchItem[] = [
  ...
  // ============ DEEP DIVES (audio) ============
  {
    ...
    title: "Spotify's Manifesto for a Frictionless World",
    category: "Deep Dives",
    brand: "Spotify",
    duration: "18 min",
    description:
  ...
  {
    id: "airbnb-deep-dive",
    title: "Airbnb's Secret Guide to Manufacturing Trust",
    category: "Deep Dives",
    brand: "Airbnb",
    duration: "18 min",
    description:
      "How Airbnb engineers trust between strangers — through copy, layout, and the quiet design of every interaction.",
    variant: 4,
    mediaType: "audio",
  ...
  },
  {
    ...
    title: "Why YouTube Music Killed the Library",
    category: "Deep Dives",
    brand: "YouTube Music",
    duration: "18 min",
    description:
      "A close look at the design choice that broke the music-collection metaphor — and what it cost the product.",
    variant: 3,
    mediaType: "audio",
